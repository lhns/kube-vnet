...
44. [0044 — A reconciler's trigger set must cover its read set](0044-trigger-sets-must-cover-read-sets.md)
45. [0045 — Network wait for opted-in pods](0045-network-wait-for-opted-in-pods.md)
